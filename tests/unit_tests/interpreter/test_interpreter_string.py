...
class StringInterpreterTests(unittest.TestCase):
    ...
    def test_string_regular(self):
        ...
        Test (string "hi").
        """
        self.assertEqual(self._interpret(b"\x01\x00\x00\x00\x00\x00\x00\x00\x0F\x68\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x0F\x69\x00\x00\x00\x00\x00\x00\x1B\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00"), "\"hi\"\n")

    def test_string_newline(self):
        """
        Test (string "h\ni").
        """
        self.assertEqual(self._interpret(b""), "\"h\ni\"\n")
