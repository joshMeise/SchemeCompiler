...
class StringInterpreterTests(unittest.TestCase):
    ...
    def test_string_regular(self):
        ...
        Test (string "hi").
        """
        self.assertEqual(self._interpret(b"\x1C\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00\x68\x00\x00\x00\x00\x00\x00\x00\x69\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00"), "\"hi\"\n")

    def test_string_newline(self):
        """
        Test (string "h\ni").
        """
        self.assertEqual(self._interpret(b"\x1C\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00\x00\x00\x00\x00\x68\x00\x00\x00\x00\x00\x00\x00\x0A\x00\x00\x00\x00\x00\x00\x00\x69\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00"), "\"h\ni\"\n")
