...
class LetInterpreterTests(unittest.TestCase):
    ...
    def test_let_many_nested_1(self):
        ...
        """
        self.assertEqual(self._interpret(b""), "6\n")

    def test_let_many_nested_2(self):
        """
        Test (let ((a 4)) (let ((a (let ((a 5)) a))) (let ((a 6)) a)))
        """
        self.assertEqual(self._interpret(b""), "6\n")
