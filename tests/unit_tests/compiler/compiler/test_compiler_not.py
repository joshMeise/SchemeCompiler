...
class NotCompileTests(unittest.TestCase):
    ...
    def test_not_nested(self):
        ...
        Test (not (not 1)).
        """
        self.assertEqual(self._compile(["not", ["not", 1]]), b"\x01\x00\x00\x00\x00\x00\x00\x00\x04\x00\x00\x00\x00\x00\x00\x00\x09\x00\x00\x00\x00\x00\x00\x00\x09\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00")

    def test_not_double_nested(self):
        """
        Test (not (not (not #\a))).
        """
        self.assertEqual(self._compile(["not", ["not", ["not", "#\\a"]]]), b"\x01\x00\x00\x00\x00\x00\x00\x00\x0F\x61\x00\x00\x00\x00\x00\x00\x09\x00\x00\x00\x00\x00\x00\x00\x09\x00\x00\x00\x00\x00\x00\x00\x09\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00")
