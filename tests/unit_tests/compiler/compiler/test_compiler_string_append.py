...
class StringRefCompileTests(unittest.TestCase):
    ...
    def test_string_append_regular(self):
        ...
        """
        self.assertEqual(self._compile(["string-append", ["string", "#\\h", "#\\i"], ["string", "#\\h", "#\\o"]]), b"")
