# test_parser_lt.py < tests (< e1 e2) parsing
#
# Josh Meise
# 01-21-2026
# Description:
...
class LTParseTests(unittest.TestCase):
    ...
    def test_lt_two_args_whitespace(self):
        """
        Test (< 1 2) with whitespace.
        """
        self.assertEqual(self._parse("    (   <   1    2   )     "), ["<", 1, 2])

    def test_lt_two_args_invalid(self):
        """
    ...
    def test_lt_second_nested(self):
        """
        Tests (< 1 (< 2 3)).
        """
        self.assertEqual(self._parse("(< 1 (< 2 3))"), ["<", 1, ["<", 2, 3]])

    def test_lt_both_nested(self):
        """
        Tests (< (< 1 2) (< 3 4)).
        """
