...
%type <nval> s add1 sub1 int_to_char char_to_int is_null is_zero not is_int is_bool plus minus lt gt leq geq eq integer boolean
...
integer: NUMBER                             { ast_node_t* node = $$; $$ = create_node(fixnum, (void*)&node, NULL, NULL); }
       ;

boolean: BOOL                               { bool val; if (!(strcmp($1, "#t"))) val = true; else val = false; $$ = create_node(boolean, (void*)&val, NULL, NULL); free($1); }
       ;
